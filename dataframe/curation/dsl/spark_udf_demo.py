...
if __name__ == '__main__':
    ...
    sample_df = sparkSession.createDataFrame(
        [(1, 'some data'),
         (2, 'some more data'),
         (3, 'even more data')
         ]
