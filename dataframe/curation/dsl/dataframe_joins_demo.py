...
if __name__ == '__main__':
    ...
    # Requirement :
    #  joining empployee dataframe with itself to find out superior emp_id and name for all employees
    print('\n***************************** Dataframe self join *****************************')
    employees_self_join_df = employees_df.alias('emp1')\
...
# |9     |Alex    |2              |2010       |-1         |M     |5000  |null   |null         |null    |
# +------+--------+---------------+-----------+-----------+------+------+-------+-------------+--------+
#
#
# ***************************** Dataframe Left/Left outer join *****************************
